...
async def lycia(client, message):
    ...
    if chat_id in en_chats:
        ...
        result = result.replace("Hi~", "Hello Friend I Am TG-chatbot")
...
async def redaura(client, message):
    ...
    result = result.replace("Eliza", "TG-chatbot")
    result = result.replace("Hi~", "Hello Friend I Am TG-chatbot")
    result = result.replace("My dear great botmaster, @slbotzone.", "Made By @supunma")
    result = result.replace("Have the control right.", "My Father Is @supunma")
    result = result.replace("I was created by @slbotzone Team.", "I was created by @supunma.")
    result = result.replace("<a href=\\", "<a href =")
    result = result.replace("<\/a>", "</a>")
...
async def redaura(client, message):
    ...
    result = result.replace("Eliza", "TG-chatbot")
    result = result.replace("Hi~", "Hello Friend I Am TG-chatbot")
    result = result.replace("My dear great botmaster, Daisybot Team.", "Made By @supunma")
    result = result.replace("Have the control right.", "My Father Is @supunma")
    result = result.replace("I was created by @slbotzoneTeam.", "I was created by @supunma.")
    result = result.replace("<a href=\\", "<a href =")
    result = result.replace("<\/a>", "</a>")
    pro = result
    if not "en" in lan and not lan == "":
